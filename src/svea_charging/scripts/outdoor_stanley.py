...
class OutdoorStanley(rx.Node):
    ...
    map_waypoints_a_to_charge = rx.Parameter(
    ...
    map_waypoints_b_to_charge = rx.Parameter(
    ...
    @rx.Subscriber(String, "outdoor_stanley/location")
    def _location(self, msg: String):
        self.location = msg.data
        self.direction = "from_A" if self.location == "A" else "from_B"
        self.waypoints = (
            self.route_a_to_charge if self.direction == "from_A"
            else self.route_b_to_charge
        )
    ...
    def on_startup(self):
        ...
        self.route_a_to_charge = self._parse_waypoints(str(self.map_waypoints_a_to_charge))
        self.route_b_to_charge = self._parse_waypoints(str(self.map_waypoints_b_to_charge))
    ...
    def _initialize_path(self):
        ...
        self.get_logger().info(
            f"Route toward charger {self.direction} initialized with {len(self.waypoints)} "
